...
In einer weiteren Abstraktion werden die einzelnen Funktionen und ihre Kommunikationsbeziehungen zu den verschiedenen Akteuren dargestellt. Dabei handelt es sich nicht um Ablaufdiagramme, sondern um eine Modellierung des erwarteten Verhaltens der Software.

\section{AWD der groben Funktionalität}
Abbildung \ref{AWD} zeigt die oberste Abstraktionsebene der Anwendungsfalldiagramme. Die enthaltenen \textit{abstrakten Funktionen} gruppieren dabei mehrere verwandte Anwendungsf\"alle.
